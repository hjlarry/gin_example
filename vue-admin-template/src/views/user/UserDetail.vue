  ...
  <div class="app-container">
    <el-form ref="user" :model="user" :rules="rules">
      ...
      <el-form-item prop="username">
        <MDinput v-model="user.username" name="name" :maxlength="20" :readonly="isEdit">
          Username
        </MDinput>
      </el-form-item>

      <el-form-item prop="password">
        <MDinput v-model="user.password" name="name" :maxlength="64" type="password">
          Password
        </MDinput>
      </el-form-item>

      <el-form-item prop="email">
        <MDinput v-model="user.email" name="name" :maxlength="20" type="email" required>
          Email
        </MDinput>
      </el-form-item>
